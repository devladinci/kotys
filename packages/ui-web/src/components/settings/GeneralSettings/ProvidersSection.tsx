...
export function ProvidersSection() {
  ...
  const handleOmlxEnabledChange = (e: ChangeEvent<HTMLInputElement>) =>
    void setOmlxEnabled(e.target.checked);

  const handleOmlxHostChange = (e: ChangeEvent<HTMLInputElement>) =>
    void setOmlxHost(e.target.value);

  const handleOmlxApiKeyChange = (e: ChangeEvent<HTMLInputElement>) =>
    void setOmlxApiKey(e.target.value);
        ...
        <div className="rounded-lg border border-border p-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <input
              ...
              type="checkbox"
              checked={omlxEnabled}
              onChange={handleOmlxEnabledChange}
          ...
          <div className={omlxEnabled ? "" : "opacity-50 pointer-events-none"}>
            ...
            <input
              ...
              type="password"
              value={omlxApiKey}
              onChange={handleOmlxApiKeyChange}
              placeholder={
                omlxApiKeyPresent
                  ? "••••••••••••  (stored — type to replace)"
                  : "sk-omlx-..."
